...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README.rdoc", "lib/alastrina.rb"]
  s.files = ["README.rdoc", "Rakefile", "gem-public_cert.pem", "lib/alastrina.rb", "Manifest", "alastrina.gemspec"]
  s.homepage = %q{http://github.com/medined/alastrina}
  s.rdoc_options = ["--line-numbers", "--inline-source", "--title", "Alastrina", "--main", "README.rdoc"]
  s.require_paths = ["lib"]
